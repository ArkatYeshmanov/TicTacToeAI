...
You should write only integers as your answer. Because the code does not translate letters to integers. If you write integers out of the range from 1 to 9, you will make no move. Likewise if you write a number with an already
taken spot. If your number does not meet the requirements, the bot will still make a move.

As soon as one of the players has 3 'X' or 3 'O' in a row game will be ended. A winner will be the one who got 3 'X' or 3 'O' in a row.
